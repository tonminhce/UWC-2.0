        ...
        <nav className={styles.leftDashboard__grid}>
            <div className={styles.leftDashboard__content}>
                ...
                <div className={styles.leftDashboard__body}>
                    ...
                    <div className={styles.leftDashboard__body__item}> <i className={styles.leftDashboard__body__item__icon}><MdOutlineAnalytics /></i> <span className={styles.leftDashboard__body__item__text}><Link to={"/dashboards/map"}>{t("Maps")}</Link></span> </div>
